...
class DemandDetectorMessenger: public G4UImessenger
{
  ...
  private:
    ...
    G4UIcmdWithAnInteger*        fNzCmd;
	  ...
	  G4UIcmdWithoutParameter* fUseS2230Assembly;
	  G4UIcmdWithAString *         fBGOMaskCmd;
	  G4UIcmdWithABool *           fUseDRAGONCmd;
	  G4UIcmdWithABool *           fUseChamberCmd;
	  G4UIcmdWithAString*          fS2230ThresholdCmd;
	  G4UIcmdWithADoubleAndUnit*   fS2230ThresholdSigmaCmd;
