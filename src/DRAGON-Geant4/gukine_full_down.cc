...
namespace DRAGON
{
void DRAGONPrimaryGeneratorAction::gukine_full_down(G4Event* anEvent, G4GeneralParticleSource* fGPSParticleGun)
{
 //C======================================================================C
...
auto gv = GlobalVariables::GetInstance();
	...
	G4double clight = 29979245800.;  //light velocity in cm s −1 ;
      ...
      std::cout << "gukine_full_down.cc" << std::endl; 
      ...
      if(fphys->Getalpha())
        {
         ...
         rndm[1] = G4UniformRand();
         phi = 3.141592654/2.0*rndm[0]+3.141592654/4.0 +3.141592654;  //!Takes a 1.4 of a pie by down notch
