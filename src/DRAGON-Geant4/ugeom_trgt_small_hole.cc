...
void DRAGONDetectorConstruction::ugeo_trgt_small_hole()
     { 
	...
	G4VSolid* ATC0_solid = new G4Tubs("ATC0",shape[0]*cm,shape[1]*cm,shape[2]*cm,0.0*deg,360.0*deg);
	material = materials->Copper;
	G4LogicalVolume* ATC0_log = new G4LogicalVolume(ATC0_solid, material,"ATC0");
    G4VPhysicalVolume* ATC0_phys = new G4PVPlacement(0,G4ThreeVector(0.0*cm,0.0*cm,8.93048077*cm),ATC0_log,"ATC0",EX9G_log,false,0,checkOverlaps);  
