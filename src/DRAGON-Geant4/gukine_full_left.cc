...
void DRAGONPrimaryGeneratorAction::gukine_full_left(G4Event* anEvent, G4GeneralParticleSource* fGPSParticleGun)
{
 //C======================================================================C
...
auto gv = GlobalVariables::GetInstance();
      ...
      G4int ip;
      G4double cosp_r,cost_r, x_r, y_r, z_r;  //From rescom.hh
      G4double tofg;
      ...
      std::cout << "gukine_full_left.cc" << std::endl; 
      ...
      if(fphys->Getalpha())
        {
         ...
         rndm[1] = G4UniformRand();
         phi = 3.141592654/2.0*rndm[0]+3.141592654/4.0 -3.141592654/2.0; //! Just takes a 1/4 of a pie 
         thet = std::acos(1.0-rndm[1]*0.0003125); //! 0.0003125 between 0 and 25 mrad;
         //c         thet = 0.;
         cost_r = std::cos(thet);
         cosp_r = std::cos(phi);
         //! std::cout << phi << ", " << thet;
