...
void DRAGONDetectorConstruction::ugeo_trgt_small_left()
     { 
	...
	//CCC Collimator for alpha test
  	...
  	G4VPhysicalVolume* ATC1_phys = new G4PVPlacement(0,G4ThreeVector((1.2885+0.7+2.5)*cm,0.0*cm,8.93048077*cm),ATC1_log,"ATC1",EX9G_log,false,0,checkOverlaps);  
  	...
  	G4VPhysicalVolume* ATC2_phys = new G4PVPlacement(0,G4ThreeVector((1.2885-0.7-2.5)*cm,0.0*cm,8.93048077*cm),ATC2_log,"ATC2",EX9G_log,false,0,checkOverlaps);  
  	...
  	G4VPhysicalVolume* ATC3_phys = new G4PVPlacement(0,G4ThreeVector(0.0*cm,(.465+2.5)*cm,8.93048077*cm),ATC3_log,"ATC3",EX9G_log,false,0,checkOverlaps);  
  	...
  	G4VPhysicalVolume* ATC4_phys = new G4PVPlacement(0,G4ThreeVector(0.0*cm,(-0.465-2.5)*cm,8.93048077*cm),ATC4_log,"ATC4",EX9G_log,false,0,checkOverlaps);  
      ...
      EN1G_log->SetUserLimits(EN1GLimits);   //From ugstmed_trgt.f
