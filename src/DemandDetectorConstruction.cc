...
// void DemandDetectorConstruction::ConstructS2230Detectors(
...
// 	auto ConstructDetectorWithCasing = [&](){
// 		// Outer box
...
// 		// PMT is placed in the air inside casing
...
// 	auto shellLV = ConstructDetectorWithCasing();
